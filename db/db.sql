...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 24, 2024 at 09:43 AM
...
(1, 'Bangladesh', 'Bangladesh', NULL, 1, NULL, NULL);
...
(1, 1, 'Chattagram', 'চট্টগ্রাম', 'www.chittagongdiv.gov.bd', NULL, NULL),
(2, 1, 'Rajshahi', 'রাজশাহী', 'www.rajshahidiv.gov.bd', NULL, NULL),
(3, 1, 'Khulna', 'খুলনা', 'www.khulnadiv.gov.bd', NULL, NULL),
(4, 1, 'Barisal', 'বরিশাল', 'www.barisaldiv.gov.bd', NULL, NULL),
(5, 1, 'Sylhet', 'সিলেট', 'www.sylhetdiv.gov.bd', NULL, NULL),
(6, 1, 'Dhaka', 'ঢাকা', 'www.dhakadiv.gov.bd', NULL, NULL),
(7, 1, 'Rangpur', 'রংপুর', 'www.rangpurdiv.gov.bd', NULL, NULL),
(8, 1, 'Mymensingh', 'ময়মনসিংহ', 'www.mymensinghdiv.gov.bd', NULL, NULL);
...
(9, '2021_12_12_000000_create_users_table', 1),
(10, '2023_05_28_043442_create_roles_table', 1),
(11, '2023_05_28_043700_create_permissions_table', 1),
(12, '2023_05_28_043713_create_model_has_permissions_table', 1),
(13, '2023_05_28_043935_create_model_has_roles_table', 1),
(14, '2023_05_28_044009_create_role_has_permissions_table', 1),
(15, '2023_11_29_111348_add_role_acces_column', 1),
(16, '2023_12_30_135303_create_activity_logs_table', 1),
(17, '2024_01_16_064942_create_settings_table', 1),
(18, '2023_12_31_075530_create_activity_log_view', 2),
(19, '2024_03_20_170831_create_products_table', 2),
(20, '2024_03_20_224202_create_sales_table', 3),
(22, '2024_03_22_171853_create_sale_details_table', 4);
...
CREATE TABLE IF NOT EXISTS `permissions` (
  ...
  `type` int DEFAULT NULL COMMENT '1=view,2=add,3=edit,4=status,5=delete',
...
INSERT INTO `permissions` (`id`, `name`, `display_name`, `module`, `description`, `type`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'rbac', 'RBAC', NULL, 'MODULE', NULL, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(2, 'role', 'Role', 'RBAC', 'FEATURE', NULL, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(3, 'role.index', 'Role List', 'RBAC', 'Role', 1, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(4, 'role.create', 'Role Insert', 'RBAC', 'Role', 2, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(5, 'role.edit', 'Role Edit', 'RBAC', 'Role', 3, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(6, 'role.delete', 'Role Delete', 'RBAC', 'Role', 5, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(7, 'role.view', 'Role View', 'RBAC', 'Role', 6, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(8, 'role.assign-permission', 'Assign Permission', 'RBAC', 'Role', 6, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(9, 'user', 'User', 'User', 'FEATURE', NULL, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(10, 'user.index', 'List', 'User', 'User', 1, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(11, 'user.create', 'Create', 'User', 'User', 2, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(12, 'user.edit', 'Edit', 'User', 'User', 3, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(13, 'user.delete', 'Delete', 'User', 'User', 5, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(14, 'product', 'Product', 'Product', 'FEATURE', NULL, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(15, 'product.index', 'List', 'Product', 'Product', 1, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(16, 'product.create', 'Create', 'Product', 'Product', 2, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(17, 'prodcut.edit', 'Edit', 'Product', 'Product', 3, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(18, 'product.delete', 'Delete', 'Product', 'Product', 5, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(19, 'sale', 'Sale', 'Sale', 'FEATURE', NULL, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(20, 'sale.index', 'List', 'Sale', 'Sale', 1, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(21, 'sale.create', 'POS', 'Sale', 'Sale', 2, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14'),
(22, 'sale.view', 'Details', 'Sale', 'Sale', 3, NULL, NULL, NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14');
...
(4, 'App\\Models\\User', 1, 'pharmacy', 'e696a2c6339421e735b5deebcd72eafed07bd412aeaa16a21c267df9a5a1ef3b', '[\"*\"]', NULL, NULL, '2024-03-22 10:14:47', '2024-03-22 10:14:47'),
(5, 'App\\Models\\User', 1, 'pharmacy', '3188d9c4f45dec6c5dfabb370ceda72dde451c69c696d57739ba06c640f592ad', '[\"*\"]', '2024-03-23 22:24:00', NULL, '2024-03-23 22:23:58', '2024-03-23 22:24:00'),
(6, 'App\\Models\\User', 1, 'pharmacy', 'c8773df4db87899e5e52a38e17fb1f0a837f76e456e21c12df535b6f41420ef6', '[\"*\"]', '2024-03-24 03:42:48', NULL, '2024-03-23 22:32:13', '2024-03-24 03:42:48');
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `unit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'kg,litter,pieces',
  ...
  `status` tinyint NOT NULL COMMENT 'active=1,inactive=0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `products` (`id`, `name`, `sku`, `unit`, `unit_value`, `selling_price`, `purchase_price`, `discount`, `tax`, `image`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Kyler Botsford', 'POS9860', 'kg', 26.00, 378.00, 100.00, 33.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-11 07:24:25', '2023-04-22 07:22:40', NULL),
(2, 'Brennon Blanda', 'POS5885', 'kg', 18.00, 409.00, 150.00, 13.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-20 16:32:52', '2024-02-17 02:51:24', NULL),
(3, 'Sherman Dickens', 'POS4377', 'box', 99.00, 145.00, 16.00, 11.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-03 12:38:12', '2024-01-01 09:30:28', NULL),
(4, 'Dr. Nico Harber Jr.', 'POS5678', 'box', 22.00, 11.00, 49.00, 0.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-16 20:17:20', '2024-01-26 04:08:38', NULL),
(5, 'Prof. Makenna Wunsch II', 'POS7957', 'kg', 96.00, 56.00, 111.00, 29.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-20 10:36:07', '2023-04-22 04:04:09', NULL),
(6, 'Jaquan Maggio', 'POS1538', 'box', 51.00, 388.00, 189.00, 19.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-21 07:05:23', '2023-07-26 16:16:15', NULL),
(7, 'Hunter Klein', 'POS8657', 'kg', 0.00, 315.00, 264.00, 25.00, 3.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-15 14:11:26', '2023-12-05 16:48:55', NULL),
(8, 'Pierce Cassin', 'POS2455', 'box', 31.00, 208.00, 71.00, 6.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-24 00:17:28', '2023-12-25 00:39:30', NULL),
(9, 'Quinton Waters Jr.', 'POS5215', 'kg', 58.00, 84.00, 273.00, 6.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-06 18:07:42', '2024-01-05 09:22:26', NULL),
(10, 'Gilbert Satterfield I', 'POS6524', 'kg', 2.00, 124.00, 233.00, 18.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-13 13:35:37', '2023-09-10 23:10:14', NULL),
(11, 'Shanny Corkery I', 'POS7917', 'pcs', 67.00, 47.00, 123.00, 15.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-10 21:40:15', '2023-07-22 13:47:12', NULL),
(12, 'Mr. Kale Morissette V', 'POS8352', 'kg', 15.00, 443.00, 124.00, 47.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-14 15:59:34', '2023-07-01 12:35:14', NULL),
(13, 'Mrs. Deborah Legros V', 'POS4799', 'kg', 96.00, 109.00, 277.00, 39.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-01 12:41:10', '2023-09-04 12:27:43', NULL),
(14, 'Prof. Harrison Kassulke', 'POS9568', 'box', 27.00, 207.00, 49.00, 29.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-06 20:16:14', '2023-11-21 17:47:14', NULL),
(15, 'Junior Hahn III', 'POS2367', 'kg', 23.00, 265.00, 77.00, 6.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-12 22:38:48', '2023-04-16 00:00:37', NULL),
(16, 'Miss Alivia Weissnat', 'POS225', 'box', 29.00, 254.00, 53.00, 47.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-20 20:27:33', '2024-01-07 10:10:45', NULL),
(17, 'Isabell Boyer', 'POS6057', 'pcs', 70.00, 47.00, 20.00, 1.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-17 06:59:52', '2023-06-10 04:03:01', NULL),
(18, 'Kristy Rolfson', 'POS9817', 'kg', 90.00, 68.00, 98.00, 50.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-05 03:36:26', '2023-05-13 21:18:28', NULL),
(19, 'Mabelle Franecki', 'POS4276', 'kg', 94.00, 439.00, 54.00, 1.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-03 12:59:25', '2024-03-13 23:55:47', NULL),
(20, 'Ewell Boehm DVM', 'POS8032', 'pcs', 4.00, 448.00, 179.00, 31.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-03-28 03:04:22', '2023-12-23 21:06:29', NULL),
(21, 'Cassidy Crist', 'POS2574', 'kg', 83.00, 40.00, 54.00, 24.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-01 16:43:28', '2023-06-09 23:53:08', NULL),
(22, 'Dr. Blaise Kautzer', 'POS1299', 'box', 58.00, 397.00, 59.00, 34.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-22 23:33:03', '2023-08-18 01:47:08', NULL),
(23, 'Chyna Dooley', 'POS7598', 'pcs', 35.00, 167.00, 259.00, 15.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-01 14:32:18', '2023-09-07 14:13:13', NULL),
(24, 'Austyn Bergstrom', 'POS7842', 'box', 30.00, 500.00, 134.00, 28.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-29 04:06:18', '2024-03-14 03:28:23', NULL),
(25, 'Ms. Gerda Kling', 'POS7280', 'pcs', 59.00, 168.00, 288.00, 33.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-22 22:23:39', '2024-02-14 10:31:12', NULL),
(26, 'Braden Blanda', 'POS9461', 'pcs', 25.00, 119.00, 118.00, 29.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-25 13:01:04', '2024-01-10 22:54:25', NULL),
(27, 'Aric Gerlach I', 'POS4244', 'kg', 4.00, 211.00, 156.00, 35.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-14 19:40:52', '2023-12-05 09:59:59', NULL),
(28, 'Zachary Kautzer', 'POS1708', 'pcs', 97.00, 324.00, 6.00, 50.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-30 08:38:03', '2023-08-18 13:38:46', NULL),
(29, 'Sophie Feil', 'POS8726', 'kg', 0.00, 463.00, 246.00, 6.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-14 10:21:37', '2023-09-22 08:46:14', NULL),
(30, 'Bianka Morissette', 'POS1029', 'pcs', 20.00, 431.00, 230.00, 16.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-10 17:25:36', '2023-12-03 12:03:22', NULL),
(31, 'Pansy Jast IV', 'POS18', 'pcs', 75.00, 414.00, 147.00, 18.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-27 06:36:01', '2023-09-22 14:42:33', NULL),
(32, 'Christiana Spencer', 'POS8040', 'pcs', 28.00, 87.00, 121.00, 21.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-31 01:31:47', '2023-07-30 15:19:58', NULL),
(33, 'Lucile Haley V', 'POS614', 'box', 63.00, 18.00, 160.00, 13.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-03 17:20:15', '2023-08-11 14:00:53', NULL),
(34, 'Mr. Jo Kertzmann DDS', 'POS8154', 'kg', 10.00, 398.00, 76.00, 14.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-05 10:33:05', '2023-05-25 18:51:07', NULL),
(35, 'Prof. Aracely Schultz MD', 'POS9837', 'box', 10.00, 30.00, 135.00, 19.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-07 09:02:45', '2024-01-10 10:51:26', NULL),
(36, 'Roxane Smitham', 'POS8522', 'kg', 62.00, 69.00, 131.00, 13.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-04 01:02:40', '2023-12-18 13:07:07', NULL),
(37, 'Thurman Hackett', 'POS4699', 'kg', 52.00, 331.00, 288.00, 16.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-07 21:40:53', '2023-10-27 21:34:41', NULL),
(38, 'Sven Crooks III', 'POS2974', 'pcs', 0.00, 219.00, 130.00, 47.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-18 13:29:09', '2024-03-18 13:54:37', NULL),
(39, 'Gwen Spinka', 'POS6767', 'box', 10.00, 440.00, 57.00, 34.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-18 23:04:55', '2023-10-04 14:52:52', NULL),
(40, 'Pearline Muller', 'POS2517', 'kg', 40.00, 467.00, 286.00, 32.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-21 20:57:42', '2024-02-02 23:57:38', NULL),
(41, 'Clemmie Sanford', 'POS3726', 'box', 50.00, 497.00, 214.00, 40.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-11 04:50:08', '2023-12-10 14:02:12', NULL),
(42, 'Reese Goldner IV', 'POS2202', 'pcs', 92.00, 130.00, 277.00, 36.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-03 17:47:41', '2024-01-05 06:15:11', NULL),
(43, 'Jarrod Beier MD', 'POS7113', 'pcs', 74.00, 59.00, 13.00, 1.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-21 20:23:56', '2023-10-08 09:01:14', NULL),
(44, 'Dr. Amari Lowe IV', 'POS2373', 'pcs', 88.00, 331.00, 34.00, 19.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-04 03:06:11', '2024-02-09 20:12:55', NULL),
(45, 'Miss Eve Runolfsdottir IV', 'POS6828', 'pcs', 54.00, 261.00, 116.00, 15.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-13 14:31:15', '2023-09-23 08:51:48', NULL),
(46, 'Camren Kirlin IV', 'POS9641', 'pcs', 39.00, 243.00, 281.00, 46.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-14 17:34:17', '2024-01-22 19:56:59', NULL),
(47, 'Prof. Margaretta White', 'POS2800', 'box', 57.00, 472.00, 120.00, 36.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-03 15:06:29', '2023-07-11 12:56:24', NULL),
(48, 'Leonie Tillman DDS', 'POS3665', 'box', 31.00, 56.00, 270.00, 35.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-14 04:35:41', '2023-08-29 07:22:44', NULL),
(49, 'Dr. Bertram Brakus', 'POS6701', 'kg', 27.00, 35.00, 298.00, 50.00, 3.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-08 08:25:58', '2023-06-24 00:23:34', NULL),
(50, 'Eli Moore', 'POS3469', 'pcs', 63.00, 183.00, 194.00, 41.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-21 23:06:40', '2023-04-23 04:18:09', NULL),
(51, 'Wilton Gerhold', 'POS184', 'box', 67.00, 399.00, 270.00, 45.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-24 10:42:23', '2023-04-07 01:40:20', NULL),
(52, 'Mr. Delbert Douglas DVM', 'POS3462', 'pcs', 82.00, 292.00, 71.00, 50.00, 3.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-14 05:27:24', '2023-09-17 01:15:21', NULL),
(53, 'Lavina Wintheiser', 'POS6233', 'kg', 83.00, 299.00, 140.00, 46.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-24 06:05:54', '2023-06-16 19:56:29', NULL),
(54, 'Prof. Carmel DuBuque V', 'POS8124', 'kg', 81.00, 98.00, 84.00, 5.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-09 05:31:31', '2023-11-21 00:30:41', NULL),
(55, 'Arlie Deckow', 'POS6601', 'box', 45.00, 445.00, 76.00, 39.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-13 20:59:56', '2023-04-16 21:28:51', NULL),
(56, 'Jakayla Sporer', 'POS13', 'kg', 92.00, 407.00, 59.00, 32.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-08 04:58:08', '2024-02-02 06:12:41', NULL),
(57, 'Hyman Kunze DVM', 'POS9032', 'kg', 44.00, 352.00, 218.00, 4.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-10 03:09:15', '2023-04-09 11:38:48', NULL),
(58, 'Mr. Kyler Schmitt', 'POS1552', 'box', 10.00, 106.00, 78.00, 13.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-12 07:25:36', '2023-11-25 19:23:12', NULL),
(59, 'Adelia Bailey', 'POS9108', 'pcs', 34.00, 291.00, 147.00, 33.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-02 21:37:22', '2023-08-27 08:10:49', NULL),
(60, 'Mrs. Kari Ernser V', 'POS2308', 'kg', 44.00, 21.00, 16.00, 36.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-12 02:58:56', '2023-05-01 01:05:10', NULL),
(61, 'Jarret Nitzsche', 'POS8995', 'box', 67.00, 452.00, 9.00, 49.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-11 22:35:46', '2023-07-06 16:47:02', NULL),
(62, 'Prof. Brad D\'Amore', 'POS8954', 'kg', 67.00, 20.00, 109.00, 4.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-09 10:59:09', '2023-05-04 00:28:29', NULL),
(63, 'Noemy Dare', 'POS1377', 'pcs', 6.00, 330.00, 98.00, 18.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-30 02:59:02', '2023-11-02 05:29:01', NULL),
(64, 'Adah Crooks Sr.', 'POS9892', 'pcs', 57.00, 149.00, 83.00, 0.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-03 16:09:49', '2023-10-15 22:40:02', NULL),
(65, 'Mazie Cremin', 'POS9694', 'box', 67.00, 281.00, 264.00, 47.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-17 01:45:32', '2023-10-21 05:07:59', NULL),
(66, 'Isadore Goodwin I', 'POS7149', 'box', 52.00, 358.00, 201.00, 37.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-25 06:31:46', '2023-05-29 17:27:45', NULL),
(67, 'Glenda Rempel', 'POS1175', 'kg', 89.00, 37.00, 229.00, 41.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-17 07:47:43', '2023-07-05 16:34:15', NULL),
(68, 'Clarabelle Stehr', 'POS5504', 'pcs', 53.00, 172.00, 50.00, 14.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-02 07:12:14', '2023-06-13 14:27:38', NULL),
(69, 'Webster Anderson', 'POS2087', 'kg', 10.00, 26.00, 111.00, 33.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-13 12:38:26', '2023-11-06 14:25:27', NULL),
(70, 'Dr. Rosie Carroll III', 'POS1842', 'box', 4.00, 408.00, 44.00, 26.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-23 22:50:18', '2023-05-06 04:09:37', NULL),
(71, 'Erwin VonRueden', 'POS4297', 'pcs', 74.00, 348.00, 12.00, 46.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-31 19:05:34', '2023-07-23 12:05:02', NULL),
(72, 'Caesar Rosenbaum', 'POS8380', 'kg', 2.00, 346.00, 230.00, 10.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-20 22:31:54', '2023-05-03 20:55:50', NULL),
(73, 'Tyree Heathcote', 'POS2417', 'pcs', 11.00, 46.00, 115.00, 47.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-05 18:03:50', '2023-11-19 20:52:15', NULL),
(74, 'Shaina Williamson', 'POS998', 'box', 68.00, 77.00, 193.00, 6.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-19 01:21:24', '2023-06-20 05:10:27', NULL),
(75, 'Mr. Green Ebert', 'POS1991', 'pcs', 39.00, 248.00, 131.00, 48.00, 3.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-24 11:04:58', '2023-07-22 02:24:34', NULL),
(76, 'Ms. Kyra Hahn', 'POS4304', 'pcs', 68.00, 284.00, 300.00, 8.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-03 06:04:26', '2024-01-07 08:37:02', NULL),
(77, 'Jazlyn Hagenes', 'POS8831', 'box', 82.00, 19.00, 13.00, 30.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-14 16:43:00', '2023-12-22 02:37:37', NULL),
(78, 'Jennifer Hickle', 'POS5432', 'pcs', 83.00, 12.00, 279.00, 13.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-26 18:52:16', '2023-11-07 17:41:30', NULL),
(79, 'Noah Weimann', 'POS5637', 'pcs', 32.00, 490.00, 33.00, 12.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-18 02:58:52', '2023-07-19 02:45:56', NULL),
(80, 'Jaime Feil', 'POS4615', 'pcs', 51.00, 167.00, 218.00, 5.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-03 07:53:23', '2023-07-18 23:07:08', NULL),
(81, 'Miss Odessa Rice Jr.', 'POS908', 'kg', 61.00, 285.00, 30.00, 42.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-09 21:15:07', '2023-05-25 14:47:48', NULL),
(82, 'Prof. Ashton Connelly I', 'POS4555', 'kg', 73.00, 284.00, 179.00, 33.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-21 16:31:56', '2024-02-14 20:46:38', NULL),
(83, 'Mr. Louisa Doyle DDS', 'POS8538', 'kg', 76.00, 337.00, 143.00, 41.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-01 18:47:54', '2023-10-02 03:39:26', NULL),
(84, 'Nyah Sanford Sr.', 'POS2963', 'box', 94.00, 441.00, 127.00, 12.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-17 00:32:15', '2023-06-19 09:20:30', NULL),
(85, 'Mr. Quinten Jacobson MD', 'POS6722', 'pcs', 45.00, 144.00, 154.00, 45.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-14 21:15:27', '2023-11-21 04:38:34', NULL),
(86, 'Maximilian Kovacek', 'POS6247', 'kg', 88.00, 59.00, 289.00, 15.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-13 14:45:34', '2023-12-07 05:43:42', NULL),
(87, 'Griffin Kuhlman DDS', 'POS5080', 'kg', 83.00, 232.00, 160.00, 49.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-02 18:35:24', '2023-10-04 06:35:13', NULL),
(88, 'Saige Casper', 'POS4175', 'pcs', 57.00, 255.00, 106.00, 20.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-23 08:55:04', '2023-12-12 22:26:34', NULL),
(89, 'Chloe Witting', 'POS6261', 'pcs', 92.00, 202.00, 39.00, 40.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-23 21:19:31', '2023-07-28 15:44:41', NULL),
(90, 'Vicky White', 'POS4046', 'kg', 22.00, 252.00, 295.00, 4.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-01 20:35:27', '2023-08-11 04:48:45', NULL),
(91, 'Dejah Steuber', 'POS483', 'kg', 20.00, 47.00, 295.00, 27.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-12 11:29:27', '2023-06-23 08:48:24', NULL),
(92, 'Clement Treutel', 'POS3606', 'box', 72.00, 462.00, 67.00, 11.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-19 19:36:38', '2023-06-22 13:57:28', NULL),
(93, 'Dalton Jacobs', 'POS9320', 'kg', 58.00, 478.00, 170.00, 38.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-11 05:13:49', '2023-07-03 10:18:21', NULL),
(94, 'Dr. Mario Bartell MD', 'POS6610', 'kg', 43.00, 148.00, 282.00, 43.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-09 20:46:16', '2023-07-11 18:45:51', NULL),
(95, 'Guillermo Nikolaus', 'POS3169', 'box', 33.00, 414.00, 276.00, 37.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-23 03:45:56', '2023-08-07 05:22:43', NULL),
(96, 'Adan Dickens', 'POS3839', 'box', 11.00, 133.00, 285.00, 27.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-31 02:11:30', '2023-10-05 12:11:55', NULL),
(97, 'Einar Will', 'POS5689', 'box', 68.00, 90.00, 9.00, 28.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-20 10:40:32', '2023-07-26 07:35:39', NULL),
(98, 'Leonora Mueller', 'POS5094', 'box', 23.00, 379.00, 43.00, 15.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-30 06:53:53', '2023-06-05 13:59:56', NULL),
(99, 'Trisha Dicki', 'POS4831', 'kg', 64.00, 159.00, 87.00, 34.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-15 06:31:02', '2023-07-13 11:25:28', NULL),
(100, 'Gerard Gislason', 'POS8684', 'pcs', 99.00, 84.00, 299.00, 45.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-05 21:32:35', '2024-02-01 22:01:28', NULL),
(101, 'Edythe Ebert', 'POS6105', 'pcs', 45.00, 233.00, 225.00, 28.00, 3.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-01 21:40:24', '2023-05-16 03:15:26', NULL),
(102, 'Leila Wehner', 'POS754', 'pcs', 22.00, 441.00, 287.00, 48.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-28 03:17:36', '2023-04-22 01:01:16', NULL),
(103, 'Kathryne Kuhn', 'POS7420', 'pcs', 43.00, 386.00, 44.00, 15.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-16 09:46:38', '2023-08-04 15:42:23', NULL),
(104, 'Mr. Lexus Wisozk', 'POS5511', 'kg', 25.00, 496.00, 261.00, 22.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-19 20:00:08', '2023-05-26 07:37:12', NULL),
(105, 'Bertha Howell IV', 'POS2833', 'kg', 40.00, 86.00, 170.00, 48.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-31 23:47:08', '2024-01-04 08:09:41', NULL),
(106, 'Adonis Miller', 'POS7012', 'box', 35.00, 31.00, 182.00, 31.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-03 16:01:49', '2023-07-03 00:48:51', NULL),
(107, 'Ethyl Bartell', 'POS127', 'kg', 78.00, 225.00, 86.00, 9.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-03 21:46:04', '2024-02-10 15:28:48', NULL),
(108, 'Maurice Reilly', 'POS7812', 'box', 56.00, 370.00, 136.00, 31.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-17 20:43:02', '2024-03-20 19:55:54', NULL),
(109, 'Dr. Quinn Moen', 'POS3209', 'pcs', 47.00, 251.00, 240.00, 20.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-15 13:15:21', '2023-07-03 10:35:32', NULL),
(110, 'Cordie Dach DVM', 'POS3943', 'box', 93.00, 350.00, 119.00, 17.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-12 10:44:52', '2023-03-29 20:35:47', NULL),
(111, 'Richmond Ruecker', 'POS8999', 'box', 12.00, 111.00, 208.00, 27.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-02 02:47:55', '2023-09-17 11:39:26', NULL),
(112, 'Esmeralda Hoppe', 'POS7808', 'box', 90.00, 495.00, 228.00, 16.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-20 11:22:43', '2024-03-02 23:07:19', NULL),
(113, 'Aracely Pouros', 'POS4251', 'kg', 54.00, 498.00, 220.00, 32.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-12 19:51:33', '2023-08-31 07:01:59', NULL),
(114, 'Angelo Rowe', 'POS5044', 'pcs', 53.00, 348.00, 67.00, 34.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-08 04:53:02', '2023-10-10 15:52:50', NULL),
(115, 'Bettye Sanford DVM', 'POS6534', 'pcs', 14.00, 219.00, 100.00, 21.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-02 15:07:37', '2024-01-12 11:24:59', NULL),
(116, 'Prof. Ericka Jacobson IV', 'POS1467', 'pcs', 66.00, 491.00, 196.00, 20.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-05 06:19:33', '2024-03-22 18:44:36', NULL),
(117, 'Chasity Adams', 'POS6837', 'pcs', 36.00, 217.00, 123.00, 33.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-27 02:33:52', '2024-01-24 18:51:49', NULL),
(118, 'Uriel Kerluke', 'POS8400', 'kg', 73.00, 63.00, 172.00, 8.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-26 22:25:37', '2024-02-23 06:00:42', NULL),
(119, 'Ulises Barton', 'POS7219', 'box', 26.00, 326.00, 94.00, 50.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-26 19:28:22', '2023-09-26 04:55:39', NULL),
(120, 'Mrs. Marietta Jenkins', 'POS9971', 'box', 89.00, 229.00, 79.00, 22.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-11 10:05:41', '2023-10-28 02:22:09', NULL),
(121, 'Trever Johnson', 'POS8017', 'box', 72.00, 322.00, 180.00, 31.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-23 08:12:03', '2023-06-06 08:58:02', NULL),
(122, 'Alessandro Rosenbaum', 'POS6593', 'pcs', 41.00, 71.00, 29.00, 11.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-30 23:16:29', '2023-04-16 10:51:18', NULL),
(123, 'Cecelia Greenfelder', 'POS206', 'pcs', 78.00, 294.00, 105.00, 16.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-29 12:55:08', '2024-02-19 07:52:21', NULL),
(124, 'Chloe Schiller I', 'POS4152', 'kg', 6.00, 431.00, 199.00, 26.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-17 20:10:16', '2024-01-14 23:45:13', NULL),
(125, 'Omari Runte', 'POS4066', 'kg', 64.00, 107.00, 188.00, 35.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-24 10:46:50', '2023-05-30 09:53:54', NULL),
(126, 'Maximus Altenwerth PhD', 'POS1124', 'pcs', 97.00, 56.00, 87.00, 14.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-03 20:03:41', '2023-08-18 09:21:04', NULL),
(127, 'Nedra Swift', 'POS662', 'box', 31.00, 434.00, 105.00, 0.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-29 02:36:28', '2023-08-27 22:09:13', NULL),
(128, 'Alba Altenwerth', 'POS3425', 'box', 22.00, 226.00, 63.00, 33.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-14 18:47:47', '2024-01-07 03:36:44', NULL),
(129, 'Kattie Kuphal', 'POS6465', 'pcs', 37.00, 145.00, 213.00, 2.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-21 18:07:42', '2023-05-28 03:10:34', NULL),
(130, 'Rodrick Schultz', 'POS2528', 'pcs', 8.00, 129.00, 286.00, 8.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-21 14:59:04', '2023-11-04 05:28:44', NULL),
(131, 'Prof. Arely Hickle I', 'POS4394', 'box', 13.00, 495.00, 294.00, 25.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-21 00:16:51', '2024-02-18 00:38:53', NULL),
(132, 'Lauriane Carter', 'POS672', 'pcs', 28.00, 362.00, 153.00, 40.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-26 02:14:22', '2023-10-28 17:28:02', NULL),
(133, 'Lavinia Leuschke', 'POS8720', 'pcs', 63.00, 332.00, 60.00, 5.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-24 01:18:40', '2023-07-31 07:18:02', NULL),
(134, 'Seamus Bode', 'POS363', 'box', 56.00, 134.00, 36.00, 6.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-10 10:43:37', '2024-01-19 18:23:32', NULL),
(135, 'Antwon Schmidt', 'POS7229', 'pcs', 98.00, 249.00, 219.00, 7.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-23 10:38:26', '2023-04-12 17:25:05', NULL),
(136, 'Federico Wilderman', 'POS8956', 'kg', 6.00, 460.00, 84.00, 20.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-28 06:09:18', '2023-12-19 02:05:25', NULL),
(137, 'Daryl Shanahan', 'POS9637', 'kg', 78.00, 29.00, 53.00, 2.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-13 07:28:19', '2023-03-26 09:25:26', NULL),
(138, 'Mr. Ellsworth Rogahn MD', 'POS3739', 'pcs', 14.00, 402.00, 73.00, 23.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-22 09:38:43', '2024-01-27 19:59:18', NULL),
(139, 'Sheila Howe', 'POS8846', 'box', 95.00, 334.00, 52.00, 50.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-17 14:39:23', '2023-08-12 04:54:18', NULL),
(140, 'Mr. Hiram Pacocha DVM', 'POS620', 'box', 19.00, 136.00, 20.00, 30.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-23 17:09:18', '2023-05-08 08:55:17', NULL),
(141, 'Garry Beahan', 'POS6457', 'kg', 84.00, 205.00, 81.00, 5.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-29 09:18:11', '2023-07-17 20:11:41', NULL),
(142, 'Jerrod Lubowitz DVM', 'POS9845', 'pcs', 44.00, 306.00, 246.00, 31.00, 3.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-28 11:38:47', '2023-10-06 08:20:07', NULL),
(143, 'Hailee Wiegand', 'POS3671', 'kg', 44.00, 192.00, 24.00, 46.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-27 01:14:26', '2023-04-22 02:41:14', NULL),
(144, 'Prof. Ethan Bartoletti', 'POS6211', 'box', 51.00, 242.00, 208.00, 20.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-01 11:32:22', '2023-05-26 17:26:20', NULL),
(145, 'Felicia Fritsch', 'POS4800', 'pcs', 57.00, 243.00, 77.00, 19.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-18 06:08:04', '2023-11-13 12:49:03', NULL),
(146, 'Krista Kuvalis', 'POS4822', 'kg', 53.00, 437.00, 98.00, 27.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-22 17:37:35', '2023-06-10 01:28:37', NULL),
(147, 'Elva Sauer', 'POS4532', 'pcs', 87.00, 137.00, 235.00, 29.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-16 06:27:50', '2023-11-08 20:15:24', NULL),
(148, 'Ms. Euna Sanford Jr.', 'POS1160', 'box', 57.00, 448.00, 189.00, 41.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-11 22:45:11', '2023-12-05 12:55:18', NULL),
(149, 'Ms. Kaylie Schoen DDS', 'POS1536', 'pcs', 12.00, 26.00, 52.00, 48.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-08 10:28:24', '2024-01-05 13:14:52', NULL),
(150, 'Jerel Beier', 'POS6097', 'box', 86.00, 241.00, 261.00, 7.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-26 23:06:15', '2023-05-17 23:00:09', NULL),
(151, 'Prof. Austen Prosacco', 'POS8578', 'box', 45.00, 396.00, 264.00, 43.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-20 11:17:43', '2023-05-22 03:43:58', NULL),
(152, 'Amelie Gorczany DVM', 'POS9458', 'box', 25.00, 429.00, 277.00, 11.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-07 07:46:54', '2023-10-06 23:16:37', NULL),
(153, 'Dayana Yost', 'POS4979', 'box', 43.00, 393.00, 200.00, 7.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-25 08:27:57', '2023-06-13 19:05:59', NULL),
(154, 'Ignatius Wiegand', 'POS2637', 'pcs', 88.00, 457.00, 293.00, 31.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-08 14:31:06', '2024-02-14 18:44:02', NULL),
(155, 'Mrs. Camila Doyle DDS', 'POS5499', 'pcs', 90.00, 486.00, 102.00, 37.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-12-09 03:43:06', '2023-05-08 20:37:26', NULL),
(156, 'Dr. Dereck Tremblay', 'POS4952', 'kg', 20.00, 364.00, 47.00, 18.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-09 14:58:15', '2024-01-02 00:36:34', NULL),
(157, 'Prof. Randi Kuphal III', 'POS9227', 'box', 61.00, 24.00, 141.00, 30.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-08 06:23:50', '2024-02-03 22:35:30', NULL),
(158, 'Dr. Sam McKenzie', 'POS5346', 'box', 24.00, 485.00, 266.00, 22.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-03 15:49:48', '2023-12-17 08:21:15', NULL),
(159, 'Neva Ziemann', 'POS5340', 'box', 17.00, 62.00, 144.00, 47.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-27 14:18:35', '2024-02-23 01:01:30', NULL),
(160, 'Amani Block DVM', 'POS863', 'kg', 26.00, 302.00, 165.00, 31.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-10 14:43:09', '2023-11-04 15:27:55', NULL),
(161, 'Thurman Toy IV', 'POS7588', 'box', 48.00, 209.00, 141.00, 17.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-15 12:33:49', '2023-11-13 14:05:06', NULL),
(162, 'Nakia Kovacek IV', 'POS9002', 'box', 93.00, 493.00, 99.00, 21.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-11 03:04:57', '2023-04-04 09:34:49', NULL),
(163, 'Vivian McCullough', 'POS7788', 'box', 30.00, 488.00, 164.00, 47.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-18 15:40:11', '2023-12-08 20:59:50', NULL),
(164, 'Rollin Zemlak', 'POS951', 'kg', 84.00, 115.00, 228.00, 10.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-10 11:49:43', '2023-11-18 04:28:55', NULL),
(165, 'Maude Hermiston', 'POS9951', 'pcs', 11.00, 457.00, 168.00, 19.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-09 14:35:23', '2023-12-24 14:22:14', NULL),
(166, 'Henri Rippin I', 'POS2804', 'box', 17.00, 96.00, 45.00, 11.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-03 15:53:25', '2023-10-02 22:58:11', NULL),
(167, 'Quinton Bernhard', 'POS4740', 'pcs', 74.00, 422.00, 101.00, 34.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-09 22:40:03', '2023-06-02 21:19:31', NULL),
(168, 'Prof. Astrid Harris III', 'POS3969', 'box', 23.00, 209.00, 41.00, 31.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-09 18:50:11', '2023-04-24 21:22:05', NULL),
(169, 'Reva Parisian DDS', 'POS8073', 'box', 16.00, 241.00, 237.00, 22.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-03 12:04:39', '2023-10-03 14:56:18', NULL),
(170, 'Leatha McLaughlin', 'POS5272', 'box', 25.00, 181.00, 155.00, 31.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-21 23:39:29', '2023-05-27 09:00:20', NULL),
(171, 'Gonzalo Torphy', 'POS7368', 'box', 59.00, 410.00, 30.00, 11.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-01 19:21:46', '2023-10-16 21:25:02', NULL),
(172, 'Gilda Deckow', 'POS3126', 'kg', 48.00, 158.00, 268.00, 33.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-23 22:19:18', '2023-04-08 11:10:25', NULL),
(173, 'Dr. Austyn Rippin', 'POS7856', 'box', 45.00, 472.00, 136.00, 22.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-18 11:37:27', '2024-02-06 12:40:02', NULL),
(174, 'Greta Koss', 'POS882', 'kg', 70.00, 305.00, 234.00, 11.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-28 08:32:51', '2023-04-06 06:59:08', NULL),
(175, 'Natasha White', 'POS6426', 'box', 10.00, 219.00, 221.00, 44.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-24 20:01:57', '2024-01-27 21:43:16', NULL),
(176, 'Aracely Dach', 'POS1894', 'pcs', 92.00, 91.00, 172.00, 41.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-05 04:52:06', '2023-09-01 09:52:32', NULL),
(177, 'Nikki Pfeffer PhD', 'POS1648', 'kg', 54.00, 209.00, 148.00, 11.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-22 19:17:44', '2023-08-10 17:26:32', NULL),
(178, 'Rex O\'Hara I', 'POS9023', 'kg', 22.00, 183.00, 14.00, 48.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-03-11 22:34:43', '2023-09-02 20:50:23', NULL),
(179, 'Mr. Cornell Hudson III', 'POS6212', 'pcs', 49.00, 123.00, 69.00, 30.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-14 08:39:03', '2023-11-26 01:34:26', NULL),
(180, 'Franz Schaden', 'POS3257', 'box', 24.00, 40.00, 217.00, 45.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-15 22:40:05', '2023-08-06 07:56:41', NULL),
(181, 'Wilburn Hansen', 'POS3950', 'kg', 52.00, 48.00, 135.00, 40.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-13 14:14:31', '2023-10-15 14:31:18', NULL),
(182, 'Mr. Zion Turner IV', 'POS1213', 'box', 12.00, 268.00, 38.00, 30.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-06 09:30:02', '2023-12-26 21:01:21', NULL),
(183, 'Lawson Ritchie DVM', 'POS448', 'kg', 79.00, 498.00, 77.00, 7.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-21 15:04:27', '2024-01-05 19:11:51', NULL),
(184, 'Aiyana Veum', 'POS2121', 'box', 57.00, 301.00, 176.00, 48.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-07 03:28:47', '2024-03-14 19:05:20', NULL),
(185, 'Prof. Cathryn Orn', 'POS9393', 'pcs', 38.00, 460.00, 299.00, 35.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-07 06:29:42', '2024-02-25 02:04:12', NULL),
(186, 'Mr. Andre Fay', 'POS9039', 'kg', 4.00, 445.00, 43.00, 35.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-03-25 14:10:10', '2024-03-11 22:50:01', NULL),
(187, 'Mrs. Lilian Maggio', 'POS5942', 'kg', 62.00, 491.00, 164.00, 26.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-14 16:48:04', '2024-02-24 06:45:25', NULL),
(188, 'Maribel Hudson', 'POS7578', 'box', 64.00, 42.00, 126.00, 26.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-23 17:45:39', '2023-06-04 02:58:57', NULL),
(189, 'Alisha Haley III', 'POS7147', 'box', 68.00, 57.00, 54.00, 42.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-02 02:17:02', '2023-06-20 23:53:09', NULL),
(190, 'Arno Dietrich', 'POS7', 'box', 17.00, 299.00, 119.00, 4.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-27 21:51:06', '2023-05-26 10:05:26', NULL),
(191, 'Daija Casper', 'POS9237', 'box', 9.00, 417.00, 193.00, 37.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-08 01:26:48', '2023-04-28 18:03:14', NULL),
(192, 'Ms. Kaia Kling', 'POS5277', 'kg', 93.00, 499.00, 177.00, 7.00, 6.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-04-03 05:23:07', '2023-04-27 17:36:58', NULL),
(193, 'Zola Roob II', 'POS2043', 'box', 71.00, 228.00, 105.00, 20.00, 14.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-26 11:36:58', '2023-09-03 10:23:32', NULL),
(194, 'Shayna Bogan', 'POS75', 'box', 67.00, 246.00, 233.00, 30.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-05 19:20:43', '2023-10-02 13:06:19', NULL),
(195, 'Mollie Emmerich', 'POS1553', 'pcs', 65.00, 451.00, 70.00, 45.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-06-17 07:01:31', '2023-06-02 00:42:55', NULL),
(196, 'Dr. Titus Mraz', 'POS3368', 'box', 97.00, 413.00, 16.00, 9.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-22 04:14:45', '2024-01-27 17:58:17', NULL),
(197, 'Prof. Elmer Renner Sr.', 'POS306', 'box', 95.00, 139.00, 295.00, 21.00, 7.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-23 18:10:22', '2023-12-11 18:33:39', NULL),
(198, 'Lavon Waelchi', 'POS7391', 'pcs', 45.00, 321.00, 142.00, 34.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-27 12:19:49', '2024-03-17 23:46:03', NULL),
(199, 'Rosendo Mueller', 'POS565', 'kg', 98.00, 25.00, 273.00, 21.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-12 12:38:43', '2023-08-30 16:44:29', NULL),
(200, 'Marion Bogan', 'POS8309', 'kg', 38.00, 36.00, 82.00, 50.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-29 03:44:23', '2023-05-31 21:56:07', NULL),
(201, 'Mr. Lionel Dare', 'POS5977', 'pcs', 4.00, 298.00, 70.00, 22.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-20 16:13:48', '2024-02-08 11:15:15', NULL),
(202, 'Dr. Emmanuelle Jenkins V', 'POS8454', 'box', 94.00, 282.00, 159.00, 10.00, 13.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-01-24 23:49:33', '2023-09-28 11:17:10', NULL),
(203, 'Dejon Heller', 'POS7620', 'pcs', 45.00, 166.00, 43.00, 7.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-08 07:59:23', '2023-07-28 05:20:54', NULL),
(204, 'Yasmin Brakus', 'POS1453', 'kg', 26.00, 198.00, 223.00, 46.00, 9.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-05 22:50:59', '2023-07-06 12:09:35', NULL),
(205, 'Annette O\'Keefe', 'POS4145', 'box', 92.00, 257.00, 164.00, 46.00, 12.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-20 11:27:18', '2023-09-16 02:14:07', NULL),
(206, 'Domenica Schroeder', 'POS9099', 'pcs', 64.00, 61.00, 175.00, 27.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-17 22:46:32', '2024-02-14 23:43:40', NULL),
(207, 'Carmine Carroll', 'POS4661', 'box', 14.00, 355.00, 17.00, 12.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-03-24 05:22:30', '2023-04-20 12:16:04', NULL),
(208, 'Chad Toy', 'POS4609', 'pcs', 10.00, 474.00, 233.00, 5.00, 1.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-16 08:20:09', '2023-12-23 20:30:12', NULL),
(209, 'Branson Thompson PhD', 'POS3402', 'kg', 40.00, 164.00, 29.00, 40.00, 10.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-18 08:31:35', '2023-05-08 03:07:25', NULL),
(210, 'Prof. Vincenza Casper', 'POS1650', 'pcs', 86.00, 97.00, 100.00, 20.00, 4.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-05-21 02:06:34', '2023-08-23 17:45:55', NULL),
(211, 'Lonzo Cassin', 'POS4732', 'pcs', 73.00, 422.00, 260.00, 20.00, 2.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-12 15:48:11', '2023-04-26 17:10:39', NULL),
(212, 'Prof. Vicenta Adams MD', 'POS738', 'pcs', 58.00, 453.00, 16.00, 14.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-25 11:51:59', '2023-09-18 01:53:04', NULL),
(213, 'Dr. Narciso Gutkowski I', 'POS6784', 'kg', 35.00, 500.00, 271.00, 28.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-11-18 15:23:28', '2024-03-23 05:01:24', NULL),
(214, 'Mrs. Pearline Batz', 'POS1446', 'box', 66.00, 302.00, 86.00, 35.00, 0.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-10-24 15:20:57', '2023-05-28 10:13:25', NULL),
(215, 'Dixie Bailey', 'POS2463', 'pcs', 82.00, 59.00, 183.00, 19.00, 11.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2024-02-12 11:42:16', '2024-03-12 08:09:46', NULL),
(216, 'Hope Graham PhD', 'POS9069', 'kg', 9.00, 55.00, 102.00, 5.00, 5.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-09-12 23:57:19', '2024-01-16 23:35:53', NULL),
(217, 'Irma Corkery', 'POS9281', 'pcs', 10.00, 146.00, 196.00, 27.00, 8.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-07-11 17:12:01', '2023-05-23 07:08:50', NULL),
(218, 'Nathanael Hettinger', 'POS5265', 'pcs', 28.00, 17.00, 65.00, 15.00, 15.00, 'images/product/67575_6ef40b43-71c7-4194-acb5-51a4ae5657a4.jpeg', 1, '2023-08-01 13:46:15', '2023-10-31 07:54:05', NULL);
...
CREATE TABLE IF NOT EXISTS `roles` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `access_by` tinyint NOT NULL DEFAULT '1' COMMENT '1=>Only For Company,2=>All users',
  PRIMARY KEY (`id`),
...
INSERT INTO `roles` (`id`, `name`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`, `access_by`) VALUES
(1, 'super-admin', 1, NULL, NULL, NULL, NULL, NULL, 1),
(2, 'admin', 1, NULL, NULL, NULL, NULL, NULL, 1),
(3, 'owner', 1, NULL, NULL, NULL, NULL, NULL, 1),
(4, 'user', 1, NULL, NULL, NULL, NULL, NULL, 1),
(5, 'worker', 1, NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO `sales` (`id`, `subtotal`, `discount`, `tax`, `total`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 494.00, 49.40, 49.40, 494.00, '2024-03-22 11:15:52', '2024-03-22 11:15:52', NULL),
(6, 3905.00, 247.00, 247.00, 3905.00, '2024-03-22 11:34:49', '2024-03-22 11:34:49', NULL),
(7, 1769.00, 148.20, 148.20, 1769.00, '2024-03-23 22:33:48', '2024-03-23 22:33:48', NULL);
...
INSERT INTO `sale_details` (`id`, `sale_id`, `product_id`, `quantity`, `price`, `subtotal`, `discount`, `tax`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 6, 2, 5, 494.00, 2470.00, 49.40, 49.40, NULL, NULL, NULL),
(2, 6, 1, 5, 287.00, 1435.00, 0.00, 0.00, NULL, NULL, NULL),
(3, 7, 2, 3, 494.00, 1482.00, 49.40, 49.40, NULL, NULL, NULL),
(4, 7, 1, 1, 287.00, 287.00, 0.00, 0.00, NULL, NULL, NULL);
...
INSERT INTO `settings` (`id`, `post_id`, `meta_key`, `meta_value`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, NULL, 'language', '[\n    {\n        \"id\": 2,\n        \"name\": \"English\",\n        \"direction\": \"ltr\",\n        \"code\": \"en\",\n        \"status\": 1,\n        \"default\": true\n    }\n]', 1, 1, NULL, NULL, '2024-03-23 22:41:58'),
(2, NULL, 'pnc_language', '[\"en\",\"bd\",\"ar\"]', NULL, NULL, NULL, NULL, NULL),
(3, NULL, 'MAIL_HOST', 'smtp.gmail.comssaaaaaa', 1, 1, NULL, '2024-02-03 20:49:13', '2024-02-04 23:04:45'),
(4, NULL, 'MAIL_PORT', '465', 1, NULL, NULL, '2024-02-03 20:49:13', '2024-02-03 20:49:13'),
(5, NULL, 'MAIL_USERNAME', 'ictbanglabd@gmail.com', 1, NULL, NULL, '2024-02-03 20:49:13', '2024-02-03 20:49:13'),
(6, NULL, 'MAIL_PASSWORD', 'pane lqnl hjgs rplk', 1, 1, NULL, '2024-02-03 20:49:13', '2024-02-03 21:44:24'),
(7, NULL, 'MAIL_FROM_NAME', 'My Pharmacy Land ss', 1, 1, NULL, '2024-02-03 20:49:13', '2024-02-03 21:36:40'),
(8, NULL, 'MAIL_FROM_ADDRESS', 'ictbanglabd@gmail.com', 1, NULL, NULL, '2024-02-03 20:49:13', '2024-02-03 20:49:13'),
(9, NULL, 'company_name', 'Shepard Morrow Plc', 1, 1, NULL, '2024-02-04 23:19:34', '2024-02-04 23:27:30'),
(10, NULL, 'company_contanct_no', '01786740147', 1, 1, NULL, '2024-02-04 23:19:34', '2024-02-04 23:27:30'),
(11, NULL, 'company_address', 'Duncan and Newton Trading', 1, 1, NULL, '2024-02-04 23:19:34', '2024-02-04 23:27:30'),
(12, NULL, 'company_email', 'haxubahev@mailinator.com', 1, 1, NULL, '2024-02-04 23:19:34', '2024-02-04 23:27:30'),
(13, NULL, 'currency_symbol', '$', 1, NULL, NULL, '2024-02-04 23:27:30', '2024-02-04 23:27:30'),
(14, NULL, 'currency_code', 'USD', 1, NULL, NULL, '2024-02-04 23:27:30', '2024-02-04 23:27:30'),
(15, NULL, 'logo', 'images/company/52330_9a29d47c-ea13-45cb-aa5c-1d3ca218bfbe.png', 1, 1, NULL, '2024-02-04 23:30:21', '2024-02-28 00:38:37'),
(16, NULL, 'icon', 'images/company/42772_2d0ba833-2384-4e1b-8202-0163cf388725.png', 1, 1, NULL, '2024-02-04 23:36:48', '2024-02-28 00:38:37'),
(17, NULL, 'SMS_METHOD', 'RELEANS', 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(18, NULL, 'TWILIO_TOKEN', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(19, NULL, 'TWILIO_SID', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(20, NULL, 'TWILIO_SERVICE_SID', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(21, NULL, 'TWILIO_FROM', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(22, NULL, 'RELEANS_API_KEY', 'eyJhbGciOiJIUzI1NiJ9.eyJpZCI6ImQ2ZTUyY2E2LWY5ZmQtNGE4NS1hNmE2LTk2MGZmNzIyOTIzZSIsImlhdCI6MTcwNzI4MjE2NiwiaXNzIjoxODM0NH0.dY7FsCF02tl9_dWoyvXamOa63Jh2DuSE9VoSF7X-1w0', 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(23, NULL, 'RELEANS_API_FROM', 'AmarlodgeLT', 1, 1, NULL, '2024-02-06 17:33:20', '2024-02-06 17:49:31'),
(24, NULL, 'MSG91_AUTH_KEY', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(25, NULL, 'MSG91_TEMPLATE_ID', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20'),
(26, NULL, 'TWOFACTORS_API_KEY', NULL, 1, NULL, NULL, '2024-02-06 17:33:20', '2024-02-06 17:33:20');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_status` tinyint NOT NULL DEFAULT '2' COMMENT '1=active, 2=inactive',
  `country_id` int NOT NULL,
  `division_id` bigint UNSIGNED DEFAULT NULL,
  `district_id` bigint UNSIGNED DEFAULT NULL,
  `upazilas_id` bigint UNSIGNED DEFAULT NULL,
  ...
  KEY `users_upazilas_id_foreign` (`upazilas_id`),
  KEY `users_union_id_foreign` (`union_id`),
...
INSERT INTO `users` (`id`, `pharmacy_id`, `name`, `email`, `phone`, `image`, `email_verified_at`, `password`, `user_status`, `country_id`, `division_id`, `district_id`, `upazilas_id`, `union_id`, `zip_code`, `street_address`, `created_by`, `updated_by`, `remember_token`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Prof. Catalina Price', 'admin@gmail.com', '01648032586', 'image', '2024-02-27 23:40:13', '$2y$10$bWZUugaQLM/9zfEN9ifbveuohO26AF6u9ix2U86ImS8RcNNmeN3rm', 1, 0, 2, 4, 50, 72, '5786', '217 Francisca Courts Suite 822', NULL, NULL, 'kgbBCTm8mu', NULL, '2024-02-27 23:40:14', '2024-02-27 23:40:14');
...
DROP VIEW IF EXISTS `activity_log_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `activity_log_view`  AS SELECT `activity_logs`.`id` AS `log_id`, `activity_logs`.`user_id` AS `user_id`, `activity_logs`.`activity_type` AS `activity_type`, `activity_logs`.`activity` AS `activity`, `activity_logs`.`extra_info` AS `extra_info`, `users`.`name` AS `user_name`, `activity_logs`.`created_at` AS `created_at` FROM (`activity_logs` left join `users` on((`activity_logs`.`user_id` = `users`.`id`))) ;
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_union_id_foreign` FOREIGN KEY (`union_id`) REFERENCES `unions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `users_upazilas_id_foreign` FOREIGN KEY (`upazilas_id`) REFERENCES `upazilas` (`id`) ON DELETE CASCADE,
